...
class Say:
    ...
    async def _say(self, context: commands.context.Context, *, text: str):
    ...
    async def _tts(self, context: commands.context.Context, *, text: str):
    ...
    async def _reply(self, context: commands.context.Context, *, text: str):
    ...
    async def _pm(self, context: commands.context.Context, *, text: str):
